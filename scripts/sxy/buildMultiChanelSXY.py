...
/Users/rts/.jenkins/scripts/sxy/packageApks.py
                    ...
                    applicationVariants.all { variant ->
                        variant.outputs.each { output ->def outputFile= output.outputFile
                            if (outputFile != null && outputFile.name.endsWith('.apk')) {
                                        ...
                                        def fileName="rxt_${versionName}-${variant.productFlavors[0].name}.apk"
...
if __name__ == '__main__':
    ...
    fileOfChanelConfig = os.getenv("JENKINS_HOME")+"/scripts/sxy/chanelConfig"
